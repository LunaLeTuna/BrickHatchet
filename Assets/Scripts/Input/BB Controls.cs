...
public partial class @BBControls: IInputActionCollection2, IDisposable
{
    ...
    private List<IEditorKeysActions> m_EditorKeysActionsCallbackInterfaces = new List<IEditorKeysActions>();
    ...
    public struct EditorKeysActions
    {
        ...
        public void AddCallbacks(IEditorKeysActions instance)
        {
            if (instance == null || m_Wrapper.m_EditorKeysActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_EditorKeysActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IEditorKeysActions instance)
        {
            @Control.started -= instance.OnControl;
            @Control.performed -= instance.OnControl;
            @Control.canceled -= instance.OnControl;
        ...
        public void RemoveCallbacks(IEditorKeysActions instance)
        {
            if (m_Wrapper.m_EditorKeysActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IEditorKeysActions instance)
        {
            foreach (var item in m_Wrapper.m_EditorKeysActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_EditorKeysActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
